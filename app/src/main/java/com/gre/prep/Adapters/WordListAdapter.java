...
import com.gre.prep.databinding.WordCard4Binding;
import com.gre.prep.databinding.WordCardBinding;
...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.MyViewHolder> {
    ...
    public WordListAdapter(Context context, List<WordModel> wordList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new WordListAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.word_card_4, parent, false));
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        WordCard4Binding binding;


        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = WordCard4Binding.bind(itemView);
        }
    }
