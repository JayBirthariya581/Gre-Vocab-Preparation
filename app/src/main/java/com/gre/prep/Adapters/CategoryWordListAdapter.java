...
import com.gre.prep.databinding.WordCard2Binding;

import java.util.List;

public class CategoryWordListAdapter extends RecyclerView.Adapter<CategoryWordListAdapter.MyViewHolder> {
    ...
    public CategoryWordListAdapter(Context context, List<WordModel> wordList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CategoryWordListAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.word_card_2, parent, false));
    }

    public interface CrossListener{
        void onCrossed(WordModel word,int position);
    }

    public CrossListener getCrossListener() {
        return crossListener;
    }

    public void setCrossListener(CrossListener crossListener) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.binding.cross.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                selectedPosition=position;
                crossListener.onCrossed(word,position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        WordCard2Binding binding;


        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = WordCard2Binding.bind(itemView);
        }
    }
